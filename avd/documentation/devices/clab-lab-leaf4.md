...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.20.20.7/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| clab-lab_LEAF3 | Vlan4094 | 10.255.252.4 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_clab-lab-leaf3_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_CLAB-LAB-SPINE1_Ethernet4 | routed | - | 172.31.232.13/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_CLAB-LAB-SPINE2_Ethernet4 | routed | - | 172.31.232.15/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_CLAB-LAB-SPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.232.13/31
!
interface Ethernet2
   description P2P_LINK_TO_CLAB-LAB-SPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.232.15/31
!
interface Ethernet3
   description MLAG_PEER_clab-lab-leaf3_Ethernet3
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_clab-lab-leaf3_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_clab-lab-leaf3_Po3
   no shutdown
   switchport
...
| 172.31.232.12 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.232.14 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65102
   ...
   neighbor 10.255.251.4 description clab-lab-leaf3
   neighbor 172.31.232.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.232.12 description clab-lab-spine1_Ethernet4
   neighbor 172.31.232.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.232.14 description clab-lab-spine2_Ethernet4
