...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.20.20.5/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| clab-lab_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_clab-lab-leaf1_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_CLAB-LAB-SPINE1_Ethernet2 | routed | - | 172.31.232.5/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_CLAB-LAB-SPINE2_Ethernet2 | routed | - | 172.31.232.7/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_CLAB-LAB-SPINE1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.232.5/31
!
interface Ethernet2
   description P2P_LINK_TO_CLAB-LAB-SPINE2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.232.7/31
!
interface Ethernet3
   description MLAG_PEER_clab-lab-leaf1_Ethernet3
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_clab-lab-leaf1_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_clab-lab-leaf1_Po3
   no shutdown
   switchport
...
| 172.31.232.4 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.232.6 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_DB_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_OP_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WAN_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WEB_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_OP_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_WAN_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_OP_Zone |
| 10.255.251.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_WAN_Zone |
...
router bgp 65101
   ...
   neighbor 10.255.251.0 description clab-lab-leaf1
   neighbor 172.31.232.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.232.4 description clab-lab-spine1_Ethernet2
   neighbor 172.31.232.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.232.6 description clab-lab-spine2_Ethernet2
